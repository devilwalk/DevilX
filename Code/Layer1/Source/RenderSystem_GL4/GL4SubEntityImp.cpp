...
NSDevilX::NSRenderSystem::NSGL4::CSubEntityImp::CSubEntityImp(ISubEntityImp * interfaceImp,CEntityImp * obj)
...
NSDevilX::NSRenderSystem::NSGL4::CSubEntityImp::~CSubEntityImp()
{
	DEVILX_DELETE(mMaterial);
}

Void NSDevilX::NSRenderSystem::NSGL4::CSubEntityImp::renderForward(CLight * light,CRenderOperation & operation)
{
...
Void NSDevilX::NSRenderSystem::NSGL4::CSubEntityImp::onMessage(ISubEntityImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGL4::CSubEntityImp::onMessage(IGeometryUsageImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGL4::CSubEntityImp::_updatePrimitiveTopology()
{
