...
NSDevilX::NSRenderSystem::NSD3D11::CMaterial::CMaterial(CRenderable * renderable)
...
NSDevilX::NSRenderSystem::NSD3D11::CMaterial::~CMaterial()
{
	for(auto technique:mTechniques)
		DEVILX_DELETE(technique);
}

Void NSDevilX::NSRenderSystem::NSD3D11::CMaterial::onMessage(IMaterialImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSD3D11::CMaterial::onMessage(IColourUnitStateImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSD3D11::CMaterial::onMessage(IRenderableImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSD3D11::CMaterial::_updateConstantBuffer(Byte * buffer)
{
