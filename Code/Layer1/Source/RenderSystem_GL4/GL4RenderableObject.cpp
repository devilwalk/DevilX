...
NSDevilX::NSRenderSystem::NSGL4::CRenderableObject::CRenderableObject(IRenderableObjectImp * interfaceImp)
...
NSDevilX::NSRenderSystem::NSGL4::CRenderableObject::~CRenderableObject()
{
}

Void NSDevilX::NSRenderSystem::NSGL4::CRenderableObject::onMessage(IRenderableObjectImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGL4::CRenderableObject::onMessage(ISceneElementImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGL4::CRenderableObject::_updateTransformer()
{
	mTransformer=nullptr;
