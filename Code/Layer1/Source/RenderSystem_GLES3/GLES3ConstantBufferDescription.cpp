...
NSDevilX::NSRenderSystem::NSGLES3::CConstantBufferDescription::CConstantBufferDescription(GLuint program,GLuint index)
{
	{
		String block_name;
...
NSDevilX::NSRenderSystem::NSGLES3::CConstantBufferDescription::~CConstantBufferDescription()
{}
