...
NSDevilX::NSRenderSystem::NSGLES3::CEntityRenderableImp::CEntityRenderableImp(IEntityRenderableImp * interfaceImp,CEntityImp * obj)
...
NSDevilX::NSRenderSystem::NSGLES3::CEntityRenderableImp::~CEntityRenderableImp()
{
	DEVILX_DELETE(mMaterial);
}

Void NSDevilX::NSRenderSystem::NSGLES3::CEntityRenderableImp::renderForward(CLight * light,CRenderOperation & operation)
{
...
Void NSDevilX::NSRenderSystem::NSGLES3::CEntityRenderableImp::onMessage(IEntityRenderableImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGLES3::CEntityRenderableImp::onMessage(IGeometryUsageImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGLES3::CEntityRenderableImp::_updatePrimitiveTopology()
{
