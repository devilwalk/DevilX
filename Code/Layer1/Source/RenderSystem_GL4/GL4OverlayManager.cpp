...
NSDevilX::NSRenderSystem::NSGL4::COverlayManager::COverlayManager(CViewportImp * viewport)
	:mViewport(viewport)
{
...
NSDevilX::NSRenderSystem::NSGL4::COverlayManager::~COverlayManager()
{

}

Void NSDevilX::NSRenderSystem::NSGL4::COverlayManager::render()
{
...
Void NSDevilX::NSRenderSystem::NSGL4::COverlayManager::onMessage(IViewportImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGL4::COverlayManager::onMessage(IOverlayElementImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGL4::COverlayManager::onMessage(ITextureUnitStateImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
...
COverlayRenderable * NSDevilX::NSRenderSystem::NSGL4::COverlayManager::_getRenderable(IOverlayElementImp * element)
{
