...
NSDevilX::NSRenderSystem::NSGL4::CEntityImp::CEntityImp(IEntityImp * interfaceImp)
...
NSDevilX::NSRenderSystem::NSGL4::CEntityImp::~CEntityImp()
{}

Void NSDevilX::NSRenderSystem::NSGL4::CEntityImp::onMessage(IEntityImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGL4::CEntityImp::onMessage(ISceneElementImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGL4::CEntityImp::_updateTransformer()
{
	mTransformer=nullptr;
