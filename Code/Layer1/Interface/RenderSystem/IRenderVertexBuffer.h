...
namespace NSDevilX
{
	namespace NSRenderSystem
	{
		...
		public:
			...
			virtual Void updateTextureCoords(IEnum::ETextureCoord index=IEnum::ETextureCoord_0)=0;
