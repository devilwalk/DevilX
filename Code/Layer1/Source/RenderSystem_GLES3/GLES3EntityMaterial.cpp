...
NSDevilX::NSRenderSystem::NSGLES3::CEntityMaterial::CEntityMaterial(CSubEntityImp * subEntity)
...
Void NSDevilX::NSRenderSystem::NSGLES3::CEntityMaterial::onMessage(ISubEntityImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
