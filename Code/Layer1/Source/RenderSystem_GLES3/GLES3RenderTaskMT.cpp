...
#if DEVILX_RENDERSYSTEM_GLES3_MODE==DEVILX_RENDERSYSTEM_GLES3_MT
namespace NSDevilX
{
...
Void NSDevilX::NSRenderSystem::NSGLES3::CRenderTask::submit()
{
	CSystemImp::getSingleton().getRenderTaskThreadPool()->submitMT(NSInternal::threadFunction,this,mThreadSyncGroupID);
}

Void NSDevilX::NSRenderSystem::NSGLES3::CRenderTask::prepare()
{
	for(auto task:mTasks)
		task->prepare();
}
...
Void NSDevilX::NSRenderSystem::NSGLES3::CRenderSceneForwardTask::prepare()
{
