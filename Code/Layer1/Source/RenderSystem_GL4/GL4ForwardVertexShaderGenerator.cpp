...
NSDevilX::NSRenderSystem::NSGL4::CForwardVertexShaderGenerator::CForwardVertexShaderGenerator()
	:mOutputs(0)
{}
...
GLuint NSDevilX::NSRenderSystem::NSGL4::CForwardVertexShaderGenerator::generate() const
{
...
TVector<std::pair<String,String> > NSDevilX::NSRenderSystem::NSGL4::CForwardVertexShaderGenerator::generateMacro() const
{
