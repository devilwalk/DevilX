...
namespace NSDevilX
{
	namespace NSRenderSystem
	{
		...
		public:
			...
			virtual Void setPositions(const CFloat3 * positions,UInt32 count=0)=0;
			virtual Void updatePositions(UInt32 offset=0,UInt32 count=0)=0;
			virtual const CFloat3 * getPositions()const=0;
			virtual Void setNormals(const CFloat3 * normals,UInt32 count=0)=0;
			virtual Void updateNormals(UInt32 offset=0,UInt32 count=0)=0;
			virtual const CFloat3 * getNormals()const=0;
			virtual Void setTangents(const CFloat3 * tangents,UInt32 count=0)=0;
			virtual Void updateTangents(UInt32 offset=0,UInt32 count=0)=0;
			virtual const CFloat3 * getTangents()const=0;
			virtual Void setTextureCoords(const CFloat2 * uvs,UInt32 count=0,IEnum::ETextureCoord index=IEnum::ETextureCoord_0)=0;
