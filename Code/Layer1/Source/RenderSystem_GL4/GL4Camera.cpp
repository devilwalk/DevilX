...
NSDevilX::NSRenderSystem::NSGL4::CCamera::CCamera(ICameraImp * interfaceImp)
...
NSDevilX::NSRenderSystem::NSGL4::CCamera::~CCamera()
{}

Void NSDevilX::NSRenderSystem::NSGL4::CCamera::onMessage(ICameraImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
}

Void NSDevilX::NSRenderSystem::NSGL4::CCamera::onMessage(CSystemImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
...
Void NSDevilX::NSRenderSystem::NSGL4::CCamera::_updateConstantBuffer(Byte * buffer)
{
