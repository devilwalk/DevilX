...
NSDevilX::NSRenderSystem::NSD3D11::CEntityMaterial::CEntityMaterial(CEntityRenderableImp * renderable)
...
Void NSDevilX::NSRenderSystem::NSD3D11::CEntityMaterial::onMessage(IEntityRenderableImp * notifier,UInt32 message,VoidPtr data,Bool & needNextProcess)
{
	switch(message)
	{
