...
NSDevilX::NSRenderSystem::NSGLES3::COverlayMaterial::COverlayMaterial(CTexture * texture)
{
	if(texture)
...
NSDevilX::NSRenderSystem::NSGLES3::COverlayMaterial::~COverlayMaterial()
{
	DEVILX_DELETE(mProgram);
}

Void NSDevilX::NSRenderSystem::NSGLES3::COverlayMaterial::_updateShader()
{
...
Void NSDevilX::NSRenderSystem::NSGLES3::COverlayMaterial::_updateRasterizerState()
{
	mDisableState.push_back(GL_CULL_FACE);
	mEnabledState.push_back(GL_SCISSOR_TEST);
}

Void NSDevilX::NSRenderSystem::NSGLES3::COverlayMaterial::_updateBlendState()
{
...
Void NSDevilX::NSRenderSystem::NSGLES3::COverlayMaterial::_updateDepthStencilState()
{
...
Void NSDevilX::NSRenderSystem::NSGLES3::COverlayMaterial::_updateSamplerState()
{
