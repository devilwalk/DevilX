...
NSDevilX::NSRenderSystem::NSGLES3::CForwardPixelShaderCodeGenerator::CForwardPixelShaderCodeGenerator()
	:mFlags(0)
{}
...
GLuint NSDevilX::NSRenderSystem::NSGLES3::CForwardPixelShaderCodeGenerator::generate(const TVector<std::pair<String,String> > * extensionMacros) const
{
